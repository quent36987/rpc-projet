...
if __name__ == "__main__":
    ...
    parser.add_argument("--league", type=str, choices=["bronze", "silver", "gold"], default="gold",
    ...
    parser.add_argument("--max-item-dimensions", type=Dimension, default=MAX_TRUCK_DIMENSIONS,
